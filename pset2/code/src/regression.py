...
def main() :
    ...
    for eta in etas:
        ...
        li.append({'eta': eta, 'coefficient': model.coef_, 'num_iters': num_iters, 'cost': sum(model.cost(train_data.X, train_data.y)), 'time': time})
    ...
    print sum(model.cost(train_data.X, train_data.y))
    print tclosed
    ...
    print "decay:"
    partf_sum = sum(model.cost(train_data.X, train_data.y))
    print "num_iters: " + str(num_iters) + " time: " + str(tm) + " cost: " + str(partf_sum)
